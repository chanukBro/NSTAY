            ...
            <div className="login-area">
              ...
              <div className="buttons-create">
                <NavLink to="/studentSignup">
                  <button className="button-class-student-sign">Student</button>
                </NavLink>
                <NavLink to="/ownerSignup">
                  <button className="button-class-owner-sign">
                    Boarding Owner
                  </button>
                </NavLink>
              </div>
              ...
              <div className="form-class-create-student">
                <Form onSubmit={handleSignUp}>
                  ...
                  <button type="submit" className="button-class-login-create-student">
                    Sign Up
                  </button>
                </Form>
              </div>
